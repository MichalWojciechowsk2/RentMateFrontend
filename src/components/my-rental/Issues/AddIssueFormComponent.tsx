...
const AddIssueFormComponent: React.FC<AddIssueFormProps> = ({ propertyId, onSuccess }) => {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '100%', background: '#fff', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
            <h3 className="text-xl font-bold mb-4 text-gray-800">Zgłoś nową usterkę</h3>

            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>

                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <label style={{ fontSize: '14px', color: '#666', marginBottom: '5px' }}>Typ problemu</label>
                    <select
                        value={title}
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <label style={{ fontSize: '14px', color: '#666', marginBottom: '5px' }}>Opis problemu</label>
                    <textarea
                        value={description}
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <label style={{ fontSize: '14px', color: '#666', marginBottom: '5px' }}>Priorytet</label>
                    <select
                        value={urgency}
                    ...
                    >
                        <option value={0} style={{ color: 'black' }}>Niski</option>
                        <option value={1} style={{ color: 'black' }}>Średni</option>
                        <option value={2} style={{ color: 'black' }}>Wysoki</option>
                    </select>
                </div>
